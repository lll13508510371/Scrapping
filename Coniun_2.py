...
def save_data(array):
    with open('Coniun.csv', mode='a', encoding='utf-8') as f:
        csv_writer = csv.DictWriter(f, fieldnames=['name', 'thirty_day_average_price', 'average_price',
                                                   'thirty_day_change',
                                                   'thirty_day_sales', 'thirty_day_volume', 'total_sales',
