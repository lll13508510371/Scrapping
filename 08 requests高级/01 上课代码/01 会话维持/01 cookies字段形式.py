...
"""cookies来源"""
"""
    cookies 指的是用户身份的表示字段, 为了辨别用户身份而存在
        来源包含:
            1.服务器生成: Set-Cookie  生成的cookies服务器校不校验需要具体情况具体分析
            2.浏览器生成: 一般服务器不会校验
            3.js生成: JavaScript 是一门可以直接运行在浏览器的计算机语言, 后续需要逆向解密, js解密的专题课程
"""

"""
requests 模块发送请求是单次请求, 后续如果发送很多次请求, 默认请求之间没有任何联系
"""